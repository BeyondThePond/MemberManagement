...
# Fix for (models.W042): Auto-created primary key used when not defining a primary key type, by default 'django.db.models.AutoField'.
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            (os.path.join(BASE_DIR, "MemberManagement", "templates")),
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
GSUITE_OAUTH_CLIENT_ID = (
    "118982546822-515a0fn0ldm96ebev0af5naj6qn8pt9i.apps.googleusercontent.com"
)
